...
@Slf4j
@Component
public class ProductHealth implements ReactiveHealthIndicator, ReactiveHealthContributor {
 private  final ProductCompositeIntegration integration;
 private final WebClient webClient;

 @Autowired
 public ProductHealth(ProductCompositeIntegration integration, WebClient.Builder webClient) {
 ...
 public Mono<Health> health() {
    return getHealth(integration.getProductServiceUrl());
 }
