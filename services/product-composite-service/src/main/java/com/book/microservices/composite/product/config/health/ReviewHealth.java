...
@Slf4j
@Component
public class ReviewHealth implements ReactiveHealthIndicator, ReactiveHealthContributor {
 private  final ProductCompositeIntegration integration;
 private final WebClient webClient;

 @Autowired
 public ReviewHealth(ProductCompositeIntegration integration, WebClient.Builder webClient) {
 ...
 public Mono<Health> health() {
    return getHealth(integration.getReviewServiceUrl());
 }
